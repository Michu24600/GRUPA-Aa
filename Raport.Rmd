...
```{r Wykres obrazujący naruszenia po czyszczeniu, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8,fig.width=16}
if (!require("validate")) install.packages("validate")
library(validate)
