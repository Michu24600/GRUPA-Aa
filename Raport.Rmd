...
output: 
  html_document:
    ...
    highlight: pygments # Ładniejsze kolorowanie kodu
---

<style>
/* Główny kontener raportu */
body {
  background-color: #f8f9fa; /* Delikatne szare tło, by białe wykresy "wychodziły" do przodu */
  color: #333333;
  line-height: 1.7;
}
...
/* Wyróżnione bloki tekstu (zastąp divy tymi klasami) */
.info-box {
  padding: 20px;
...
wykres_odleglosci <- apartments_final %>%
  ...
  filter(city %in% c("Warszawa", "Gdańsk")) %>%
  ...
  scale_color_manual(values = c("Gdańsk" = "#2980b9", "Warszawa" = "#c0392b")) +
