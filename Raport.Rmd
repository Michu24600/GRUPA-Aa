...
output: 
  html_document:
    theme: 
      ...
      primary: "#27323E" # kolor Twojego nagłówka ze zdjęcia
    toc: true             
    toc_float: true        
...
<style>
/* Styl dla nagłówka stopnia 1 (np. # 2.) */
h1 {
  font-size: 2.2em;
  font-weight: bold;
  color: #2c3e50;
...
/* Styl dla nagłówka stopnia 2 (np. ## 2.2.) - TUTAJ GO ZMNIEJSZAMY */
h2 {
...
/* Opcjonalnie: automatyczne wyjustowanie całego tekstu w raporcie */
body {
  text-align: justify;
}
</style>
...
<style>
img {
  border: 2px solid #2c3e50; /* Grubość, styl i kolor ramki */
  border-radius: 5px;        /* Zaokrąglone rogi */
  padding: 5px;              /* Odstęp między wykresem a ramką */
  margin: 10px 0;            /* Odstęp od tekstu */
  box-shadow: 2px 2px 10px rgba(0,0,0,0.1); /* Subtelny cień */
}
</style>
...
```{r Interaktywna mapa punktowa cen nieruchomości, echo=FALSE, fig.height=8, fig.width=16, message=FALSE, warning=FALSE}
paleta <- colorNumeric(
  palette = "magma", 
...
```{r Wykres z bombelkami dla średniej ceny w miastach przeskalowany, echo=FALSE, fig.height=8, fig.width=16, message=FALSE, warning=FALSE}
